...
! function(a) { a.fn.slide = function(b) { return a.fn.slide.defaults = { type: "slide", effect: "fade", autoPlay: !1, delayTime: 500, interTime: 2500, triggerTime: 150, defaultIndex: 0, titCell: ".hd li", mainCell: ".bd", targetCell: null, trigger: "mouseover", scroll: 1, vis: 1, titOnClassName: "on", autoPage: !1, prevCell: ".prev", nextCell: ".next", pageStateCell: ".pageState", opp: !1, pnLoop: !0, easing: "swing", startFun: null, endFun: null, switchLoad: null, playStateCell: ".playState", mouseOverStop: !0, defaultPlay: !0, returnDefault: !1 }, this.each(function() { var c = a.extend({}, a.fn.slide.defaults, b),
   ...
   parseInt(c.triggerTime); var Q, t = parseInt(c.scroll),
    ...
    U = function() { j.removeClass(K), A && j.eq(N).addClass(K) }; if ("menu" == c.type) { return A && j.removeClass(K).eq(p).addClass(K), j.hover(function() { Q = a(this).find(c.targetCell); var b = j.index(a(this));
     I = setTimeout(function() { switch (p = b, j.removeClass(K).eq(p).addClass(K), S(), e) {
      ...
      case "slideDown":
       Q.animate({ height: "hide" }, q, G) } }), B && d.hover(function() { clearTimeout(J) }, function() { J = setTimeout(U, q) }), void 0 } if (0 == k && (k = m), R && (k = 2), x) { if (m >= u) { if ("leftLoop" == e || "topLoop" == e) { k = 0 != m % t ? (0 ^ m / t) + 1 : m / t } else { var V = m - u;
      k = 1 + parseInt(0 != V % t ? V / t + 1 : V / t), 0 >= k && (k = 1) } } else { k = 1 } j.html(""); var W = ""; if (1 == c.autoPage || "true" == c.autoPage) { for (var X = 0; k > X; X++) { W += "<li>" + (X + 1) + "</li>" } } else { for (var X = 0; k > X; X++) { W += c.autoPage.replace("$", X + 1) } } j.html(W); var j = j.children() } if (m >= u) { l.children().each(function() { a(this).width() > E && (E = a(this).width(), D = a(this).outerWidth(!0)), a(this).height() > F && (F = a(this).height(), C = a(this).outerHeight(!0)) }); var Y = l.children(),
    ...
    _ = function(b) { var c = function(c) { for (var d = c; u + c > d; d++) { b.eq(d).find("img[" + n + "]").each(function() { var b = a(this); if (b.attr("src", b.attr(n)).removeAttr(n), l.find(".clone")[0]) { for (var c = l.children(), d = 0; d < c.size(); d++) { c.eq(d).find("img[" + n + "]").each(function() { a(this).attr(n) == b.attr("src") && a(this).attr("src", a(this).attr(n)).removeAttr(n) }) } } }) } }; switch (e) {
      case "fade":
      case "fold":
      case "top":
      case "left":
   ...
   g = 0,
   h = d; if (0 == b) { return c } if (1 == (b /= e)) { return c + d } if (g || (g = 0.3 * e), h < Math.abs(d)) { h = d; var f = g / 4 } else { var f = g / (2 * Math.PI) * Math.asin(d / h) } return -(h * Math.pow(2, 10 * (b -= 1)) * Math.sin((b * e - f) * 2 * Math.PI / g)) + c }, easeOutElastic: function(a, b, c, d, e) { var f = 1.70158,
   g = 0,
   h = d; if (0 == b) { return c } if (1 == (b /= e)) { return c + d } if (g || (g = 0.3 * e), h < Math.abs(d)) { h = d; var f = g / 4 } else { var f = g / (2 * Math.PI) * Math.asin(d / h) } return h * Math.pow(2, -10 * b) * Math.sin((b * e - f) * 2 * Math.PI / g) + d + c }, easeInOutElastic: function(a, b, c, d, e) { var f = 1.70158,
   g = 0,
...
var Swiper = function(a, b) {
 ...
 function h() { var a, d = D.h.removeEventListener; if (b.onSlideClick) { for (a = 0; a < D.slides.length; a++) { d(D.slides[a], "click", k) } } if (b.onSlideTouch) { for (a = 0; a < D.slides.length; a++) { d(D.slides[a], D.touchEvents.touchStart, l) } } if (b.releaseFormElements) { var e = c("input, textarea, select", D.container); for (a = 0; a < e.length; a++) { d(e[a], D.touchEvents.touchStart, o, !0), D.support.touch && b.simulateTouch && d(e[a], "mousedown", o, !0) } } if (b.preventLinks) { var f = c("a", D.container); for (a = 0; a < f.length; a++) { d(f[a], "click", n) } } }
 ...
 function i(a) { var b = a.keyCode || a.charCode; if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey)) { if (37 === b || 39 === b || 38 === b || 40 === b) { for (var c = !1, d = D.h.getOffset(D.container), e = D.h.windowScroll().left, f = D.h.windowScroll().top, g = D.h.windowWidth(), h = D.h.windowHeight(), i = [
     ...
     k[0] >= e && k[0] <= e + g && k[1] >= f && k[1] <= f + h && (c = !0) } if (!c) { return } } N ? ((37 === b || 39 === b) && (a.preventDefault ? a.preventDefault() : a.returnValue = !1), 39 === b && D.swipeNext(), 37 === b && D.swipePrev()) : ((38 === b || 40 === b) && (a.preventDefault ? a.preventDefault() : a.returnValue = !1), 40 === b && D.swipeNext(), 38 === b && D.swipePrev()) } }

 function j(a) { var c = D._wheelEvent,
   d = 0; if (a.detail) { d = -a.detail } else { if ("mousewheel" === c) { if (b.mousewheelControlForceToAxis) { if (N) { if (!(Math.abs(a.wheelDeltaX) > Math.abs(a.wheelDeltaY))) { return } d = a.wheelDeltaX } else { if (!(Math.abs(a.wheelDeltaY) > Math.abs(a.wheelDeltaX))) { return } d = a.wheelDeltaY } } else { d = a.wheelDelta } } else { if ("DOMMouseScroll" === c) { d = -a.detail } else { if ("wheel" === c) { if (b.mousewheelControlForceToAxis) { if (N) { if (!(Math.abs(a.deltaX) > Math.abs(a.deltaY))) { return } d = -a.deltaX } else { if (!(Math.abs(a.deltaY) > Math.abs(a.deltaX))) { return } d = -a.deltaY } } else { d = Math.abs(a.deltaX) > Math.abs(a.deltaY) ? -a.deltaX : -a.deltaY } } } } } if (b.freeMode) { var f = D.getWrapperTranslate() + d; if (f > 0 && (f = 0), f < -e() && (f = -e()), D.setWrapperTransition(0), D.setWrapperTranslate(f), D.updateActiveSlide(f), 0 === f || f === -e()) { return } } else {
   (new Date).getTime() - V > 60 && (0 > d ? D.swipeNext() : D.swipePrev()), V = (new Date).getTime() } return b.autoplay && D.stopAutoplay(!0), a.preventDefault ? a.preventDefault() : a.returnValue = !1, !1 }

 function k(a) { D.allowSlideClick && (m(a), D.fireCallback(b.onSlideClick, D, a)) }

 function l(a) { m(a), D.fireCallback(b.onSlideTouch, D, a) }

 function m(a) { if (a.currentTarget) { D.clickedSlide = a.currentTarget } else { var c = a.srcElement;
   do { if (c.className.indexOf(b.slideClass) > -1) { break } c = c.parentNode } while (c);
   D.clickedSlide = c } D.clickedSlideIndex = D.slides.indexOf(D.clickedSlide), D.clickedSlideLoopIndex = D.clickedSlideIndex - (D.loopedSlides || 0) }
 ...
 function q(a) { if (D.isTouched && !b.onlyExternal && (!$ || "mousemove" !== a.type)) { var c = $ ? a.targetTouches[0].pageX : a.pageX || a.clientX,
    d = $ ? a.targetTouches[0].pageY : a.pageY || a.clientY; if ("undefined" == typeof I && N && (I = !!(I || Math.abs(d - D.touches.startY) > Math.abs(c - D.touches.startX))), "undefined" != typeof I || N || (I = !!(I || Math.abs(d - D.touches.startY) < Math.abs(c - D.touches.startX))), I) { return void(D.isTouched = !1) } if (N) { if (!b.swipeToNext && c < D.touches.startX || !b.swipeToPrev && c > D.touches.startX) { return } } else { if (!b.swipeToNext && d < D.touches.startY || !b.swipeToPrev && d > D.touches.startY) { return } } if (a.assignedToSwiper) { return void(D.isTouched = !1) } if (a.assignedToSwiper = !0, b.preventLinks && (D.allowLinks = !1), b.onSlideClick && (D.allowSlideClick = !1), b.autoplay && D.stopAutoplay(!0), !$ || 1 === a.touches.length) { if (D.isMoved || (D.callPlugins("onTouchMoveStart"), b.loop && (D.fixLoop(), D.positions.start = D.getWrapperTranslate()), b.onTouchMoveStart && D.fireCallback(b.onTouchMoveStart, D)), D.isMoved = !0, a.preventDefault ? a.preventDefault() : a.returnValue = !1, D.touches.current = N ? c : d, D.positions.current = (D.touches.current - D.touches.start) * b.touchRatio + D.positions.start, D.positions.current > 0 && b.onResistanceBefore && D.fireCallback(b.onResistanceBefore, D, D.positions.current), D.positions.current < -e() && b.onResistanceAfter && D.fireCallback(b.onResistanceAfter, D, Math.abs(D.positions.current + e())), b.resistance && "100%" !== b.resistance) { var f; if (D.positions.current > 0 && (f = 1 - D.positions.current / J / 2, D.positions.current = 0.5 > f ? J / 2 : D.positions.current * f), D.positions.current < -e()) { var g = (D.touches.current - D.touches.start) * b.touchRatio + (e() + D.positions.start);
      f = (J + g) / J; var h = D.positions.current - g * (1 - f) / 2,
       i = -e() - J / 2;
      D.positions.current = i > h || 0 >= f ? i : h } } if (b.resistance && "100%" === b.resistance && (D.positions.current > 0 && (!b.freeMode || b.freeModeFluid) && (D.positions.current = 0), D.positions.current < -e() && (!b.freeMode || b.freeModeFluid) && (D.positions.current = -e())), !b.followFinger) { return } if (b.moveStartThreshold) { if (Math.abs(D.touches.current - D.touches.start) > b.moveStartThreshold || X) { if (!X) { return X = !0, void(D.touches.start = D.touches.current) } D.setWrapperTranslate(D.positions.current) } else { D.positions.current = D.positions.start } } else { D.setWrapperTranslate(D.positions.current) } return (b.freeMode || b.watchActiveIndex) && D.updateActiveSlide(D.positions.current), b.grabCursor && (D.container.style.cursor = "move", D.container.style.cursor = "grabbing", D.container.style.cursor = "-moz-grabbin", D.container.style.cursor = "-webkit-grabbing"), Y || (Y = D.touches.current), Z || (Z = (new Date).getTime()), D.velocity = (D.touches.current - Y) / ((new Date).getTime() - Z) / 2, Math.abs(D.touches.current - Y) < 2 && (D.velocity = 0), Y = D.touches.current, Z = (new Date).getTime(), D.callPlugins("onTouchMoveEnd"), b.onTouchMove && D.fireCallback(b.onTouchMove, D, a), !1 } } }
 ...
 function r(a) { if (I && D.swipeReset(), !b.onlyExternal && D.isTouched) { D.isTouched = !1, b.grabCursor && (D.container.style.cursor = "move", D.container.style.cursor = "grab", D.container.style.cursor = "-moz-grab", D.container.style.cursor = "-webkit-grab"), D.positions.current || 0 === D.positions.current || (D.positions.current = D.positions.start), b.followFinger && D.setWrapperTranslate(D.positions.current), D.times.end = (new Date).getTime(), D.touches.diff = D.touches.current - D.touches.start, D.touches.abs = Math.abs(D.touches.diff), D.positions.diff = D.positions.current - D.positions.start, D.positions.abs = Math.abs(D.positions.diff); var c = D.positions.diff,
   ...
   5 > d && 300 > f && D.allowLinks === !1 && (b.freeMode || 0 === d || D.swipeReset(), b.preventLinks && (D.allowLinks = !0), b.onSlideClick && (D.allowSlideClick = !0)), setTimeout(function() { "undefined" != typeof D && null !== D && (b.preventLinks && (D.allowLinks = !0), b.onSlideClick && (D.allowSlideClick = !0)) }, 100); var g = e(); if (!D.isMoved && b.freeMode) { return D.isMoved = !1, b.onTouchEnd && D.fireCallback(b.onTouchEnd, D, a), void D.callPlugins("onTouchEnd") } if (!D.isMoved || D.positions.current > 0 || D.positions.current < -g) { return D.swipeReset(), b.onTouchEnd && D.fireCallback(b.onTouchEnd, D, a), void D.callPlugins("onTouchEnd") } if (D.isMoved = !1, b.freeMode) { if (b.freeModeFluid) { var h, i = 1000 * b.momentumRatio,
      j = D.velocity * i,
      k = D.positions.current + j,
      l = !1,
      m = 20 * Math.abs(D.velocity) * b.momentumBounceRatio; - g > k && (b.momentumBounce && D.support.transitions ? (-m > k + g && (k = -g - m), h = -g, l = !0, _ = !0) : k = -g), k > 0 && (b.momentumBounce && D.support.transitions ? (k > m && (k = m), h = 0, l = !0, _ = !0) : k = 0), 0 !== D.velocity && (i = Math.abs((k - D.positions.current) / D.velocity)), D.setWrapperTranslate(k), D.setWrapperTransition(i), b.momentumBounce && l && D.wrapperTransitionEnd(function() { _ && (b.onMomentumBounce && D.fireCallback(b.onMomentumBounce, D), D.callPlugins("onMomentumBounce"), D.setWrapperTranslate(h), D.setWrapperTransition(300)) }), D.updateActiveSlide(k) } return (!b.freeModeFluid || f >= 300) && D.updateActiveSlide(D.positions.current), b.onTouchEnd && D.fireCallback(b.onTouchEnd, D, a), void D.callPlugins("onTouchEnd") } H = 0 > c ? "toNext" : "toPrev", "toNext" === H && 300 >= f && (30 > d || !b.shortSwipes ? D.swipeReset() : D.swipeNext(!0, !0)), "toPrev" === H && 300 >= f && (30 > d || !b.shortSwipes ? D.swipeReset() : D.swipePrev(!0, !0)); var n = 0; if ("auto" === b.slidesPerView) { for (var o, p = Math.abs(D.getWrapperTranslate()), q = 0, r = 0; r < D.slides.length; r++) { if (o = N ? D.slides[r].getWidth(!0, b.roundLengths) : D.slides[r].getHeight(!0, b.roundLengths), q += o, q > p) { n = o; break } } n > J && (n = J) } else { n = F * b.slidesPerView } "toNext" === H && f > 300 && (d >= n * b.longSwipesRatio ? D.swipeNext(!0, !0) : D.swipeReset()), "toPrev" === H && f > 300 && (d >= n * b.longSwipesRatio ? D.swipePrev(!0, !0) : D.swipeReset()), b.onTouchEnd && D.fireCallback(b.onTouchEnd, D, a), D.callPlugins("onTouchEnd") } }
 ...
 function v(a, c, d) {
  function e() { var f = +new Date,
    l = f - g;
   h += i * l / (1000 / 60), k = "toNext" === j ? h > a : a > h, k ? (D.setWrapperTranslate(Math.ceil(h)), D._DOMAnimating = !0, window.setTimeout(function() { e() }, 1000 / 60)) : (b.onSlideChangeEnd && ("to" === c ? d.runCallbacks === !0 && D.fireCallback(b.onSlideChangeEnd, D, j) : D.fireCallback(b.onSlideChangeEnd, D, j)), D.setWrapperTranslate(a), D._DOMAnimating = !1) } var f = "to" === c && d.speed >= 0 ? d.speed : b.speed,
   g = +new Date; if (D.support.transitions || !b.DOMAnimation) { D.setWrapperTranslate(a), D.setWrapperTransition(f) } else { var h = D.getWrapperTranslate(),
    i = Math.ceil((a - h) / f * (1000 / 60)),
    j = h > a ? "toNext" : "toPrev",
    k = "toNext" === j ? h > a : a > h; if (D._DOMAnimating) { return } e() } D.updateActiveSlide(a), b.onSlideNext && "next" === c && d.runCallbacks === !0 && D.fireCallback(b.onSlideNext, D, a), b.onSlidePrev && "prev" === c && d.runCallbacks === !0 && D.fireCallback(b.onSlidePrev, D, a), b.onSlideReset && "reset" === c && d.runCallbacks === !0 && D.fireCallback(b.onSlideReset, D, a), "next" !== c && "prev" !== c && "to" !== c || d.runCallbacks !== !0 || w(c) }

 function w(a) { if (D.callPlugins("onSlideChangeStart"), b.onSlideChangeStart) { if (b.queueStartCallbacks && D.support.transitions) { if (D._queueStartCallbacks) { return } D._queueStartCallbacks = !0, D.fireCallback(b.onSlideChangeStart, D, a), D.wrapperTransitionEnd(function() { D._queueStartCallbacks = !1 }) } else { D.fireCallback(b.onSlideChangeStart, D, a) } } if (b.onSlideChangeEnd) { if (D.support.transitions) { if (b.queueEndCallbacks) { if (D._queueEndCallbacks) { return } D._queueEndCallbacks = !0, D.wrapperTransitionEnd(function(c) { D.fireCallback(b.onSlideChangeEnd, c, a) }) } else { D.wrapperTransitionEnd(function(c) { D.fireCallback(b.onSlideChangeEnd, c, a) }) } } else { b.DOMAnimation || setTimeout(function() { D.fireCallback(b.onSlideChangeEnd, D, a) }, 10) } } }

 function x() { var a = D.paginationButtons; if (a) { for (var b = 0; b < a.length; b++) { D.h.removeEventListener(a[b], "click", z) } } }

 function y() { var a = D.paginationButtons; if (a) { for (var b = 0; b < a.length; b++) { D.h.addEventListener(a[b], "click", z) } } }

 function z(a) { for (var c, d = a.target || a.srcElement, e = D.paginationButtons, f = 0; f < e.length; f++) { d === e[f] && (c = f) } b.autoplay && D.stopAutoplay(!0), D.swipeTo(c) }
 ...
 function B() { D.calcSlides(), b.loader.slides.length > 0 && 0 === D.slides.length && D.loadSlides(), b.loop && D.createLoop(), D.init(), f(), b.pagination && D.createPagination(!0), b.loop || b.initialSlide > 0 ? D.swipeTo(b.initialSlide, 0, !1) : D.updateActiveSlide(0), b.autoplay && D.startAutoplay(), D.centerIndex = D.activeIndex, b.onSwiperCreated && D.fireCallback(b.onSwiperCreated, D), D.callPlugins("onSwiperCreated") } if (!document.body.outerHTML && document.body.__defineGetter__ && HTMLElement) { var C = HTMLElement.prototype;
  ...
  b = b || {}; for (var L in K) { if (L in b && "object" == typeof b[L]) { for (var M in K[L]) { M in b[L] || (b[L][M] = K[L][M]) } } else { L in b || (b[L] = K[L]) } } D.params = b, b.scrollContainer && (b.freeMode = !0, b.freeModeFluid = !0), b.loop && (b.resistance = "100%"); var N = "horizontal" === b.mode,
  ...
  D.browser.ie10 && (O = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), D.browser.ie11 && (O = ["pointerdown", "pointermove", "pointerup"]), D.touchEvents = { touchStart: D.support.touch || !b.simulateTouch ? "touchstart" : O[0], touchMove: D.support.touch || !b.simulateTouch ? "touchmove" : O[1], touchEnd: D.support.touch || !b.simulateTouch ? "touchend" : O[2] }; for (var P = D.container.childNodes.length - 1; P >= 0; P--) { if (D.container.childNodes[P].className) { for (var Q = D.container.childNodes[P].className.split(/\s+/), R = 0; R < Q.length; R++) { Q[R] === b.wrapperClass && (E = D.container.childNodes[P]) } } } D.wrapper = E, D._extendSwiperSlide = function(a) { return a.append = function() { return b.loop ? a.insertAfter(D.slides.length - D.loopedSlides) : (D.wrapper.appendChild(a), D.reInit()), a }, a.prepend = function() { return b.loop ? (D.wrapper.insertBefore(a, D.slides[D.loopedSlides]), D.removeLoopedSlides(), D.calcSlides(), D.createLoop()) : D.wrapper.insertBefore(a, D.wrapper.firstChild), D.reInit(), a }, a.insertAfter = function(c) { if ("undefined" == typeof c) { return !1 } var d; return b.loop ? (d = D.slides[c + 1 + D.loopedSlides], d ? D.wrapper.insertBefore(a, d) : D.wrapper.appendChild(a), D.removeLoopedSlides(), D.calcSlides(), D.createLoop()) : (d = D.slides[c + 1], D.wrapper.insertBefore(a, d)), D.reInit(), a }, a.clone = function() { return D._extendSwiperSlide(a.cloneNode(!0)) }, a.remove = function() { D.wrapper.removeChild(a), D.reInit() }, a.html = function(b) { return "undefined" == typeof b ? a.innerHTML : (a.innerHTML = b, a) }, a.index = function() { for (var b, c = D.slides.length - 1; c >= 0; c--) { a === D.slides[c] && (b = c) } return b }, a.isActive = function() { return a.index() === D.activeIndex ? !0 : !1 }, a.swiperSlideDataStorage || (a.swiperSlideDataStorage = {}), a.getData = function(b) { return a.swiperSlideDataStorage[b] }, a.setData = function(b, c) { return a.swiperSlideDataStorage[b] = c, a }, a.data = function(b, c) { return "undefined" == typeof c ? a.getAttribute("data-" + b) : (a.setAttribute("data-" + b, c), a) }, a.getWidth = function(b, c) { return D.h.getWidth(a, b, c) }, a.getHeight = function(b, c) { return D.h.getHeight(a, b, c) }, a.getOffset = function() { return D.h.getOffset(a) }, a }, D.calcSlides = function(a) { var c = D.slides ? D.slides.length : !1;
   D.slides = [], D.displaySlides = []; for (var d = 0; d < D.wrapper.childNodes.length; d++) { if (D.wrapper.childNodes[d].className) { for (var e = D.wrapper.childNodes[d].className, f = e.split(/\s+/), i = 0; i < f.length; i++) { f[i] === b.slideClass && D.slides.push(D.wrapper.childNodes[d]) } } } for (d = D.slides.length - 1; d >= 0; d--) { D._extendSwiperSlide(D.slides[d]) } c !== !1 && (c !== D.slides.length || a) && (h(), g(), D.updateActiveSlide(), D.params.pagination && D.createPagination(), D.callPlugins("numberOfSlidesChanged")) }, D.createSlide = function(a, c, d) { c = c || D.params.slideClass, d = d || b.slideElement; var e = document.createElement(d); return e.innerHTML = a || "", e.className = c, D._extendSwiperSlide(e) }, D.appendSlide = function(a, b, c) { return a ? a.nodeType ? D._extendSwiperSlide(a).append() : D.createSlide(a, b, c).append() : void 0 }, D.prependSlide = function(a, b, c) { return a ? a.nodeType ? D._extendSwiperSlide(a).prepend() : D.createSlide(a, b, c).prepend() : void 0 }, D.insertSlideAfter = function(a, b, c, d) { return "undefined" == typeof a ? !1 : b.nodeType ? D._extendSwiperSlide(b).insertAfter(a) : D.createSlide(b, c, d).insertAfter(a) }, D.removeSlide = function(a) { if (D.slides[a]) { if (b.loop) { if (!D.slides[a + D.loopedSlides]) { return !1 } D.slides[a + D.loopedSlides].remove(), D.removeLoopedSlides(), D.calcSlides(), D.createLoop() } else { D.slides[a].remove() } return !0 } return !1 }, D.removeLastSlide = function() { return D.slides.length > 0 ? (b.loop ? (D.slides[D.slides.length - 1 - D.loopedSlides].remove(), D.removeLoopedSlides(), D.calcSlides(), D.createLoop()) : D.slides[D.slides.length - 1].remove(), !0) : !1 }, D.removeAllSlides = function() { for (var a = D.slides.length, b = D.slides.length - 1; b >= 0; b--) { D.slides[b].remove(), b === a - 1 && D.setWrapperTranslate(0) } }, D.getSlide = function(a) { return D.slides[a] }, D.getLastSlide = function() { return D.slides[D.slides.length - 1] }, D.getFirstSlide = function() { return D.slides[0] }, D.activeSlide = function() { return D.slides[D.activeIndex] }, D.fireCallback = function() { var a = arguments[0]; if ("[object Array]" === Object.prototype.toString.call(a)) { for (var c = 0; c < a.length; c++) { "function" == typeof a[c] && a[c](arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]) } } else { "[object String]" === Object.prototype.toString.call(a) ? b["on" + a] && D.fireCallback(b["on" + a], arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]) : a(arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]) } }, D.addCallback = function(a, b) { var c, e = this; return e.params["on" + a] ? d(this.params["on" + a]) ? this.params["on" + a].push(b) : "function" == typeof this.params["on" + a] ? (c = this.params["on" + a], this.params["on" + a] = [], this.params["on" + a].push(c), this.params["on" + a].push(b)) : void 0 : (this.params["on" + a] = [], this.params["on" + a].push(b)) }, D.removeCallbacks = function(a) { D.params["on" + a] && (D.params["on" + a] = null) }; var S = []; for (var T in D.plugins) { if (b[T]) { var U = D.plugins[T](D, b[T]);
    U && S.push(U) } } D.callPlugins = function(a, b) { b || (b = {}); for (var c = 0; c < S.length; c++) { a in S[c] && S[c][a](b) } }, !D.browser.ie10 && !D.browser.ie11 || b.onlyExternal || D.wrapper.classList.add("swiper-wp8-" + (N ? "horizontal" : "vertical")), b.freeMode && (D.container.className += " swiper-free-mode"), D.initialized = !1, D.init = function(a, c) { var d = D.h.getWidth(D.container, !1, b.roundLengths),
   ...
   W.cursor = "move", W.cursor = "grab", W.cursor = "-moz-grab", W.cursor = "-webkit-grab" } D.allowSlideClick = !0, D.allowLinks = !0; var X, Y, Z, $ = !1,
   _ = !0;
  D.swipeNext = function(a, c) { "undefined" == typeof a && (a = !0), !c && b.loop && D.fixLoop(), !c && b.autoplay && D.stopAutoplay(!0), D.callPlugins("onSwipeNext"); var d = D.getWrapperTranslate().toFixed(2),
    f = d; if ("auto" === b.slidesPerView) { for (var g = 0; g < D.snapGrid.length; g++) { if (-d >= D.snapGrid[g].toFixed(2) && -d < D.snapGrid[g + 1].toFixed(2)) { f = -D.snapGrid[g + 1]; break } } } else { var h = F * b.slidesPerGroup;
    ...
    f = F * b.slidesPerGroup; - e(); if ("auto" === b.slidesPerView) { c = 0; for (var g = 0; g < D.snapGrid.length; g++) { if (-d === D.snapGrid[g]) { return } if (-d >= D.snapGrid[g] && -d < D.snapGrid[g + 1]) { c = D.positions.diff > 0 ? -D.snapGrid[g + 1] : -D.snapGrid[g]; break } } - d >= D.snapGrid[D.snapGrid.length - 1] && (c = -D.snapGrid[D.snapGrid.length - 1]), d <= -e() && (c = -e()) } else { c = 0 > d ? Math.round(d / f) * f : 0, d <= -e() && (c = -e()) } return b.scrollContainer && (c = 0 > d ? d : 0), c < -e() && (c = -e()), b.scrollContainer && J > F && (c = 0), c === d ? !1 : (v(c, "reset", { runCallbacks: a }), !0) }, D.swipeTo = function(a, c, d) { a = parseInt(a, 10), D.callPlugins("onSwipeTo", { index: a, speed: c }), b.loop && (a += D.loopedSlides); var f = D.getWrapperTranslate(); if (!(a > D.slides.length - 1 || 0 > a)) { var g; return g = "auto" === b.slidesPerView ? -D.slidesGrid[a] : -a * F, g < -e() && (g = -e()), g === f ? !1 : ("undefined" == typeof d && (d = !0), v(g, "to", { index: a, speed: c, runCallbacks: d }), !0) } }, D._queueStartCallbacks = !1, D._queueEndCallbacks = !1, D.updateActiveSlide = function(a) { if (D.initialized && 0 !== D.slides.length) { D.previousIndex = D.activeIndex, "undefined" == typeof a && (a = D.getWrapperTranslate()), a > 0 && (a = 0); var c; if ("auto" === b.slidesPerView) { if (D.activeIndex = D.slidesGrid.indexOf(-a), D.activeIndex < 0) { for (c = 0; c < D.slidesGrid.length - 1 && !(-a > D.slidesGrid[c] && -a < D.slidesGrid[c + 1]); c++) {} var d = Math.abs(D.slidesGrid[c] + a),
      ...
      D.activeIndex = e >= d ? c : c + 1 } } else { D.activeIndex = Math[b.visibilityFullFit ? "ceil" : "round"](-a / F) } if (D.activeIndex === D.slides.length && (D.activeIndex = D.slides.length - 1), D.activeIndex < 0 && (D.activeIndex = 0), D.slides[D.activeIndex]) { if (D.calcVisibleSlides(a), D.support.classList) { var f; for (c = 0; c < D.slides.length; c++) { f = D.slides[c], f.classList.remove(b.slideActiveClass), D.visibleSlides.indexOf(f) >= 0 ? f.classList.add(b.slideVisibleClass) : f.classList.remove(b.slideVisibleClass) } D.slides[D.activeIndex].classList.add(b.slideActiveClass) } else { var g = new RegExp("\\s*" + b.slideActiveClass),
       h = new RegExp("\\s*" + b.slideVisibleClass); for (c = 0; c < D.slides.length; c++) { D.slides[c].className = D.slides[c].className.replace(g, "").replace(h, ""), D.visibleSlides.indexOf(D.slides[c]) >= 0 && (D.slides[c].className += " " + b.slideVisibleClass) } D.slides[D.activeIndex].className += " " + b.slideActiveClass } if (b.loop) { var i = D.loopedSlides;
      D.activeLoopIndex = D.activeIndex - i, D.activeLoopIndex >= D.slides.length - 2 * i && (D.activeLoopIndex = D.slides.length - 2 * i - D.activeLoopIndex), D.activeLoopIndex < 0 && (D.activeLoopIndex = D.slides.length - 2 * i + D.activeLoopIndex), D.activeLoopIndex < 0 && (D.activeLoopIndex = 0) } else { D.activeLoopIndex = D.activeIndex } b.pagination && D.updatePagination(a) } } }, D.createPagination = function(a) { if (b.paginationClickable && D.paginationButtons && x(), D.paginationContainer = b.pagination.nodeType ? b.pagination : c(b.pagination)[0], b.createPagination) { var d = "",
     e = D.slides.length,
     f = e;
    b.loop && (f -= 2 * D.loopedSlides); for (var g = 0; f > g; g++) { d += "<" + b.paginationElement + ' class="' + b.paginationElementClass + '"></' + b.paginationElement + ">" } D.paginationContainer.innerHTML = d } D.paginationButtons = c("." + b.paginationElementClass, D.paginationContainer), a || D.updatePagination(), D.callPlugins("onCreatePagination"), b.paginationClickable && y() }, D.updatePagination = function(a) { if (b.pagination && !(D.slides.length < 1)) { var d = c("." + b.paginationActiveClass, D.paginationContainer); if (d) { var e = D.paginationButtons; if (0 !== e.length) { for (var f = 0; f < e.length; f++) { e[f].className = b.paginationElementClass } var g = b.loop ? D.loopedSlides : 0; if (b.paginationAsRange) { D.visibleSlides || D.calcVisibleSlides(a); var h, i = []; for (h = 0; h < D.visibleSlides.length; h++) { var j = D.slides.indexOf(D.visibleSlides[h]) - g;
        b.loop && 0 > j && (j = D.slides.length - 2 * D.loopedSlides + j), b.loop && j >= D.slides.length - 2 * D.loopedSlides && (j = D.slides.length - 2 * D.loopedSlides - j, j = Math.abs(j)), i.push(j) } for (h = 0; h < i.length; h++) { e[i[h]] && (e[i[h]].className += " " + b.paginationVisibleClass) } b.loop ? void 0 !== e[D.activeLoopIndex] && (e[D.activeLoopIndex].className += " " + b.paginationActiveClass) : e[D.activeIndex] && (e[D.activeIndex].className += " " + b.paginationActiveClass) } else { b.loop ? e[D.activeLoopIndex] && (e[D.activeLoopIndex].className += " " + b.paginationActiveClass + " " + b.paginationVisibleClass) : e[D.activeIndex] && (e[D.activeIndex].className += " " + b.paginationActiveClass + " " + b.paginationVisibleClass) } } } } }, D.calcVisibleSlides = function(a) { var c = [],
    d = 0,
    e = 0,
    f = 0;
   N && D.wrapperLeft > 0 && (a += D.wrapperLeft), !N && D.wrapperTop > 0 && (a += D.wrapperTop); for (var g = 0; g < D.slides.length; g++) { d += e, e = "auto" === b.slidesPerView ? N ? D.h.getWidth(D.slides[g], !0, b.roundLengths) : D.h.getHeight(D.slides[g], !0, b.roundLengths) : F, f = d + e; var h = !1;
    b.visibilityFullFit ? (d >= -a && -a + J >= f && (h = !0), -a >= d && f >= -a + J && (h = !0)) : (f > -a && -a + J >= f && (h = !0), d >= -a && -a + J > d && (h = !0), -a > d && f > -a + J && (h = !0)), h && c.push(D.slides[g]) } 0 === c.length && (c = [D.slides[D.activeIndex]]), D.visibleSlides = c }; var ab, bb;
  D.startAutoplay = function() { if (D.support.transitions) { if ("undefined" != typeof ab) { return !1 } if (!b.autoplay) { return } D.callPlugins("onAutoplayStart"), b.onAutoplayStart && D.fireCallback(b.onAutoplayStart, D), A() } else { if ("undefined" != typeof bb) { return !1 } if (!b.autoplay) { return } D.callPlugins("onAutoplayStart"), b.onAutoplayStart && D.fireCallback(b.onAutoplayStart, D), bb = setInterval(function() { b.loop ? (D.fixLoop(), D.swipeNext(!0, !0)) : D.swipeNext(!0, !0) || (b.autoplayStopOnLast ? (clearInterval(bb), bb = void 0) : D.swipeTo(0)) }, b.autoplay) } }, D.stopAutoplay = function(a) { if (D.support.transitions) { if (!ab) { return } ab && clearTimeout(ab), ab = void 0, a && !b.autoplayDisableOnInteraction && D.wrapperTransitionEnd(function() { A() }), D.callPlugins("onAutoplayStop"), b.onAutoplayStop && D.fireCallback(b.onAutoplayStop, D) } else { bb && clearInterval(bb), bb = void 0, D.callPlugins("onAutoplayStop"), b.onAutoplayStop && D.fireCallback(b.onAutoplayStop, D) } }, D.loopCreated = !1, D.removeLoopedSlides = function() { if (D.loopCreated) { for (var a = 0; a < D.slides.length; a++) { D.slides[a].getData("looped") === !0 && D.wrapper.removeChild(D.slides[a]) } } }, D.createLoop = function() { if (0 !== D.slides.length) { D.loopedSlides = "auto" === b.slidesPerView ? b.loopedSlides || 1 : b.slidesPerView + b.loopAdditionalSlides, D.loopedSlides > D.slides.length && (D.loopedSlides = D.slides.length); var a, c = "",
     d = "",
     e = "",
     f = D.slides.length,
     g = Math.floor(D.loopedSlides / f),
     h = D.loopedSlides % f; for (a = 0; g * f > a; a++) { var i = a; if (a >= f) { var j = Math.floor(a / f);
      i = a - f * j } e += D.slides[i].outerHTML } for (a = 0; h > a; a++) { d += u(b.slideDuplicateClass, D.slides[a].outerHTML) } for (a = f - h; f > a; a++) { c += u(b.slideDuplicateClass, D.slides[a].outerHTML) } var k = c + e + E.innerHTML + e + d; for (E.innerHTML = k, D.loopCreated = !0, D.calcSlides(), a = 0; a < D.slides.length; a++) {
     (a < D.loopedSlides || a >= D.slides.length - D.loopedSlides) && D.slides[a].setData("looped", !0) } D.callPlugins("onCreateLoop") } }, D.fixLoop = function() { var a;
   ...
   D.activeLoaderIndex = 0; for (var c = b.loader.slides, d = b.loader.loadAllSlides ? c.length : b.slidesPerView * (1 + b.loader.surroundGroups), e = 0; d > e; e++) { a += "outer" === b.loader.slidesHTMLType ? c[e] : "<" + b.slideElement + ' class="' + b.slideClass + '" data-swiperindex="' + e + '">' + c[e] + "</" + b.slideElement + ">" } D.wrapper.innerHTML = a, D.calcSlides(!0), b.loader.loadAllSlides || D.wrapperTransitionEnd(D.reloadSlides, !0) }, D.reloadSlides = function() { var a = b.loader.slides,
    c = parseInt(D.activeSlide().data("swiperindex"), 10); if (!(0 > c || c > a.length - 1)) { D.activeLoaderIndex = c; var d = Math.max(0, c - b.slidesPerView * b.loader.surroundGroups),
     ...
     D.setWrapperTranslate(f), D.setWrapperTransition(0) } var g; if ("reload" === b.loader.logic) { D.wrapper.innerHTML = ""; var h = ""; for (g = d; e >= g; g++) { h += "outer" === b.loader.slidesHTMLType ? a[g] : "<" + b.slideElement + ' class="' + b.slideClass + '" data-swiperindex="' + g + '">' + a[g] + "</" + b.slideElement + ">" } D.wrapper.innerHTML = h } else { var i = 1000,
...
Swiper.prototype = { plugins: {}, wrapperTransitionEnd: function(a, b) {
  function c(h) { if (h.target === f && (a(e), e.params.queueEndCallbacks && (e._queueEndCallbacks = !1), !b)) { for (d = 0; d < g.length; d++) { e.h.removeEventListener(f, g[d], c) } } } var d, e = this,
   f = e.wrapper,
   g = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"]; if (a) { for (d = 0; d < g.length; d++) { e.h.addEventListener(f, g[d], c) } } }, getWrapperTranslate: function(a) { var b, c, d, e, f = this.wrapper; return "undefined" == typeof a && (a = "horizontal" === this.params.mode ? "x" : "y"), this.support.transforms && this.params.useCSS3Transforms ? (d = window.getComputedStyle(f, null), window.WebKitCSSMatrix ? e = new WebKitCSSMatrix("none" === d.webkitTransform ? "" : d.webkitTransform) : (e = d.MozTransform || d.OTransform || d.MsTransform || d.msTransform || d.transform || d.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"), b = e.toString().split(",")), "x" === a && (c = window.WebKitCSSMatrix ? e.m41 : parseFloat(16 === b.length ? b[12] : b[4])), "y" === a && (c = window.WebKitCSSMatrix ? e.m42 : parseFloat(16 === b.length ? b[13] : b[5]))) : ("x" === a && (c = parseFloat(f.style.left, 10) || 0), "y" === a && (c = parseFloat(f.style.top, 10) || 0)), c || 0 }, setWrapperTranslate: function(a, b, c) { var d, e = this.wrapper.style,
   f = { x: 0, y: 0, z: 0 };
  ...
  b.webkitTransitionDuration = b.MsTransitionDuration = b.msTransitionDuration = b.MozTransitionDuration = b.OTransitionDuration = b.transitionDuration = a / 1000 + "s", this.callPlugins("onSetWrapperTransition", { duration: a }), this.params.onSetWrapperTransition && this.fireCallback(this.params.onSetWrapperTransition, this, a) }, h: { getWidth: function(a, b, c) { var d = window.getComputedStyle(a, null).getPropertyValue("width"),
    ...
    e = parseFloat(d); return (isNaN(e) || d.indexOf("%") > 0 || 0 > e) && (e = a.offsetHeight - parseFloat(window.getComputedStyle(a, null).getPropertyValue("padding-top")) - parseFloat(window.getComputedStyle(a, null).getPropertyValue("padding-bottom"))), b && (e += parseFloat(window.getComputedStyle(a, null).getPropertyValue("padding-top")) + parseFloat(window.getComputedStyle(a, null).getPropertyValue("padding-bottom"))), c ? Math.ceil(e) : e }, getOffset: function(a) { var b = a.getBoundingClientRect(),
    c = document.body,
    d = a.clientTop || c.clientTop || 0,
    e = a.clientLeft || c.clientLeft || 0,
    f = window.pageYOffset || a.scrollTop,
    g = window.pageXOffset || a.scrollLeft; return document.documentElement && !window.pageYOffset && (f = document.documentElement.scrollTop, g = document.documentElement.scrollLeft), { top: b.top + f - d, left: b.left + g - e } }, windowWidth: function() { return window.innerWidth ? window.innerWidth : document.documentElement && document.documentElement.clientWidth ? document.documentElement.clientWidth : void 0 }, windowHeight: function() { return window.innerHeight ? window.innerHeight : document.documentElement && document.documentElement.clientHeight ? document.documentElement.clientHeight : void 0 }, windowScroll: function() { return "undefined" != typeof pageYOffset ? { left: window.pageXOffset, top: window.pageYOffset } : document.documentElement ? { left: document.documentElement.scrollLeft, top: document.documentElement.scrollTop } : void 0 }, addEventListener: function(a, b, c, d) { "undefined" == typeof d && (d = !1), a.addEventListener ? a.addEventListener(b, c, d) : a.attachEvent && a.attachEvent("on" + b, c) }, removeEventListener: function(a, b, c, d) { "undefined" == typeof d && (d = !1), a.removeEventListener ? a.removeEventListener(b, c, d) : a.detachEvent && a.detachEvent("on" + b, c) } }, setTransform: function(a, b) { var c = a.style;
  c.webkitTransform = c.MsTransform = c.msTransform = c.MozTransform = c.OTransform = c.transform = b }, setTranslate: function(a, b) { var c = a.style,
   d = { x: b.x || 0, y: b.y || 0, z: b.z || 0 },
   e = this.support.transforms3d ? "translate3d(" + d.x + "px," + d.y + "px," + d.z + "px)" : "translate(" + d.x + "px," + d.y + "px)";
  c.webkitTransform = c.MsTransform = c.msTransform = c.MozTransform = c.OTransform = c.transform = e, this.support.transforms || (c.left = d.x + "px", c.top = d.y + "px") }, setTransition: function(a, b) { var c = a.style;
  c.webkitTransitionDuration = c.MsTransitionDuration = c.msTransitionDuration = c.MozTransitionDuration = c.OTransitionDuration = c.transitionDuration = b + "ms" }, support: { touch: window.Modernizr && Modernizr.touch === !0 || function() { return !!("ontouchstart" in window || window.DocumentTouch && document instanceof DocumentTouch) }(), transforms3d: window.Modernizr && Modernizr.csstransforms3d === !0 || function() { var a = document.createElement("div").style; return "webkitPerspective" in a || "MozPerspective" in a || "OPerspective" in a || "MsPerspective" in a || "perspective" in a }(), transforms: window.Modernizr && Modernizr.csstransforms === !0 || function() { var a = document.createElement("div").style; return "transform" in a || "WebkitTransform" in a || "MozTransform" in a || "msTransform" in a || "MsTransform" in a || "OTransform" in a }(), transitions: window.Modernizr && Modernizr.csstransitions === !0 || function() { var a = document.createElement("div").style; return "transition" in a || "WebkitTransition" in a || "MozTransition" in a || "msTransition" in a || "MsTransition" in a || "OTransition" in a }(), classList: function() { var a = document.createElement("div"); return "classList" in a }() }, browser: { ie8: function() { var a = -1; if ("Microsoft Internet Explorer" === navigator.appName) { var b = navigator.userAgent,
     c = new RegExp(/MSIE ([0-9]{1,}[\.0-9]{0,})/);
    null !== c.exec(b) && (a = parseFloat(RegExp.$1)) } return -1 !== a && 9 > a }(), ie10: window.navigator.msPointerEnabled, ie11: window.navigator.pointerEnabled } }, (window.jQuery || window.Zepto) && ! function(a) { a.fn.swiper = function(b) { var c; return this.each(function(d) { var e = a(this),
    f = new Swiper(e[0], b);
   d || (c = f), e.data("swiper", f) }), c } }(window.jQuery || window.Zepto), "undefined" != typeof module && (module.exports = Swiper), "function" == typeof define && define.amd && define([], function() { return Swiper });
var pageIndex = 0,
 preloadCount = 0;
var loopPlayback = false,
 stopSwitch = true;
var videoSwiper, casesSwiper, qualitySwiper, aboutSwiper;
$(function() { var m = document.location.href.toLowerCase().match(/#p(\d+)$/); if (m != null) { pageIndex = m[1] - 1 } preload() });

function preload() { $("body>section, .video .swiper-container, .video .swiper-slide").height($(window).height()); var selector = $("section.video .swiper-container .swiper-slide:lt(2)"); if (pageIndex > 0 && pageIndex < $("body>section").size()) { selector = $("body>section").eq(pageIndex) } preloadCount = selector.size();
 selector.each(function(i, item) { var imgUrl = $(item).css("background-image"); var m = imgUrl.match(/url\("?([^"]+)"?\)/);
  loadImage(m[1], imgLoaded) }) }

function loadImage(url, callback) { var img = new Image();
 img.src = url; if (img.complete) { preloadCount--;
  callback.call(img); return } img.onload = function() { preloadCount--;
  callback.call(img) } }

function imgLoaded() { if (preloadCount == 0) { pageLoad() } }

function pageLoad() { $("body").bind("mousewheel", function(e, delta) { if (stopSwitch) { return } stopSwitch = true;
  delta > 0 ? pageIndex-- : pageIndex++;
  pageSwitching() }).bind("touchmove", function(e) { e.preventDefault() });
 $("body").swipe({ swipeUp: function() { if (stopSwitch) { return } stopSwitch = true;
   pageIndex++;
   pageSwitching() }, swipeDown: function() { if (stopSwitch) { return } stopSwitch = true;
   pageIndex--;
   pageSwitching() } });
 ...
 $("header .menu").bind(whichTransitionEvent(), function() { $(this).trigger("mouseleave") });
 $("header .menu li").bind("click touchstart", function() { pageIndex = $(this).index();
  pageSwitching() });
 $("header .menu-icon span.glyphicon-th-large").bind("click touchstart", function() { if ($(this).hasClass("active")) { $(this).removeClass("active");
   $("header .menu").removeClass("active") } else { $(this).addClass("active");
   $("header .menu").addClass("active") } }); for (var i = 0; i < $(".video .swiper-slide").size(); i++) { $(".video .guide").append("<a></a>") } $(".video .guide a").eq(0).addClass("active");
 $(".video .nth1, .video .nth2").append('<div class="shade"></div><div class="line"><u></u></div>');
 videoSwiper = new Swiper(".video .swiper-container", { loop: true, autoplay: 5000, grabCursor: true, onSlideChangeStart: function() { resetVideoSwiperAnimation() }, onSlideChangeEnd: function() { $(".video .guide a").removeClass("active").eq(videoSwiper.activeLoopIndex).addClass("active");
   videoSwiperAnimation() }, onTouchEnd: function() { videoSwiper.startAutoplay() } });
 videoSwiper.stopAutoplay();
 $(".video .guide a").bind("mouseover click touchstart", function(e) { e.preventDefault();
  videoSwiper.stopAutoplay();
  videoSwiper.swipeTo($(this).index()) }).mouseout(function(e) { videoSwiper.startAutoplay() });
 $(".video .movedown").bind("click touchstart", function() { if (stopSwitch) { return } stopSwitch = true;
  pageIndex = 1;
  pageSwitching() });
 $(".video .news").slide({ mainCell: "ul", autoPage: true, effect: "top", interTime: 3500, autoPlay: true, vis: 1 });
 ...
 casesSwiper = new Swiper(".cases .swiper-container.mini", { loop: true, autoplay: 5000, grabCursor: true, onTouchEnd: function() { casesSwiper.startAutoplay() } });
 casesSwiper.stopAutoplay();
 $(".cases a.prev").bind("click touchstart", function(e) { e.preventDefault();
  casesSwiper.swipePrev();
  casesSwiper.startAutoplay() });
 $(".cases a.next").bind("click touchstart", function(e) { e.preventDefault();
 ...
 $(".clients ul.items li").not(".bg").bind("mouseover", function() { var x = $(this).position();
  $(this).parent().find(".one").show().css("top", x.top).css("left", x.left);
  $(".clients ul.items li").removeClass("active");
  $(this).addClass("active") });
 $(".clients ul.items").bind("mouseleave", function() { $(".clients ul.items li").removeClass("active");
 ...
 $(".quality .swiper-container .swiper-wrapper ul").each(function(i, item) { var ulWidth = 0;
  $(item).find("li").each(function(i, item) { var liMarginLeft = $(this).css("margin-left").replace("px", "");
   ulWidth += $(this).outerWidth() + liMarginLeft * 2 }); if ($.support.leadingWhitespace) { $(item).width(ulWidth) } else { $(item).width(ulWidth + 8) } });
 qualitySwiper = new Swiper(".quality .swiper-container.mini", { loop: true, autoplay: 5000, grabCursor: true, onTouchEnd: function() {} });
 $(".quality a.prev").bind("click touchstart", function(e) { e.preventDefault();
  qualitySwiper.swipePrev() });
 $(".quality a.next").bind("click touchstart", function(e) { e.preventDefault();
  qualitySwiper.swipeNext() });
 $(".marketing").append('<div class="shade"></div>');
 $(".marketing ul.items li").prepend('<u class="cl"></u><u class="cr"></u>'); var menu = $(".aboutus ul.menu");
 ...
 aboutSwiper = new Swiper(".aboutus .swiper-container.items", { loop: true, autoplay: 6000, grabCursor: true, onSlideChangeStart: function() { var li = $(".aboutus ul.menu li").eq(aboutSwiper.activeLoopIndex); var x = li.position();
   li.parent().find(".one").css("top", x.top).css("left", x.left);
   $(".aboutus ul.menu li").removeClass("active");
   li.addClass("active") }, onTouchEnd: function() { aboutSwiper.startAutoplay() } });
 aboutSwiper.stopAutoplay();
 $(".aboutus ul.menu li").not(".bg").bind("mouseover click touchstart", function(e) { e.preventDefault();
  aboutSwiper.stopAutoplay();
  aboutSwiper.swipeTo($(this).index()) }).bind("mouseout", function() { aboutSwiper.startAutoplay() }).eq(0).addClass("active");
 $(".contact .box .wechat img").addClass("img-responsive");
 $(window).bind("resize", function(e) { initLayout(); var lock = false; var selector = "body>section.active"; if (pageIndex == 0) { selector = ".video .swiper-slide.active .box" } $(selector).bind(whichTransitionEvent(), function() { initLayout(); if (lock) { return } else { lock = true } pageSwitching();
   $("header .menu").trigger("mouseleave");
   $(".dock").css("top", ($(window).height() - $(".dock").height()) / 2 + 35) }) });
 dockEvent(); var tEvent = whichTransitionEvent(); if (tEvent == undefined) { initLayout(); var fun = '$("div.welcome").animate({opacity:"0", zIndex:"-1"}, 500, "swing", function(){ pageSwitching(); })';
  setTimeout(fun, 600);
  pageSwitching() } else { $("div.welcome").animate({ opacity: "0", zIndex: "-1" }, 500, "swing", function() { initLayout();
   pageSwitching() }) } }

function initLayout() { $("body>section, .video .swiper-container, .video .swiper-slide").height($(window).height()); var hhNormal = $("header").height(); var hhFixed = 70; if (hhNormal == 42) { hhFixed = 60 } else { if (hhNormal == 0) { hhFixed = 0 } } var refTop = $(".video .news").offset().top; if (refTop == 0) { refTop = $(".video .guide").offset().top } refTop = refTop + hhNormal;
 $(".video .swiper-slide").each(function(i, item) { if ($(item).hasClass("nth1")) { var boxMt = parseInt((refTop - $(item).find(".left").height()) / 2); var boxWidth = $(item).find(".left").width() + $(item).find(".right").width();
   $(item).find(".box").css("margin-top", boxMt).css("width", boxWidth);
   $(item).find(".shade").css("top", boxMt - 711) } else { if ($(item).hasClass("nth2")) { var boxMt = parseInt((refTop - $(item).find(".box").height()) / 2);
    $(item).find(".box").css("top", boxMt) } else { if ($(item).hasClass("nth3")) { boxHeight = 207; if ($(item).find(".box .bottom").css("font-size") == "12px") { boxHeight = 134 } var boxMt = parseInt((refTop - boxHeight) / 2);
     $(item).find(".box").css("margin-top", boxMt) } else { if ($(item).hasClass("nth4")) { var boxMt = parseInt((refTop - $(item).find(".box").height()) / 2);
      $(item).find(".box").css("margin-top", boxMt) } } } } }); var items = $(".business ul.items li"); if ($(window).width() > 1000) { var itemMarginLeft = items.css("margin-left").replace("px", ""); var width = items.outerWidth() * items.size() + itemMarginLeft * 2 * items.size() + 4 * (items.size() - 1) + 2;
  $(".business ul.items").width(width) } else { var itemWidth = items.outerWidth() + 25; var lineSize = parseInt($(window).width() / itemWidth);
  $(".business ul.items").width(itemWidth * lineSize + 2) } var box = $(".business .box"); var boxTop = parseInt(($(window).height() - box.height() + hhFixed) / 2);
 box.css("top", boxTop); if ($(window).width() < 992) { box = $(".business.third .box");
  boxTop = parseInt(($(window).height() - box.height() + hhFixed) / 2);
  box.css("top", boxTop) } box = $(".cases .box");
 boxTop = parseInt(($(window).height() - box.height() + hhFixed) / 2);
 box.css("top", boxTop);
 box = $(".clients .box");
 boxTop = parseInt(($(window).height() - box.height() + hhFixed) / 2);
 ...
 box.css("top", boxTop); if ($(window).width() > 1000) { var itemMarginLeft = items.css("margin-left").replace("px", ""); var width = items.outerWidth() * items.size() + itemMarginLeft * 2 * items.size() + 4 * (items.size() - 1) + 2 } items = $(".aboutus .items"); if ($(window).width() > 640) { itemsTop = parseInt(($(window).height() - items.height() + hhFixed - $(".aboutus table.exp").height()) / 2) } else { if ($(window).width() > 413) { itemsTop = parseInt(($(window).height() - items.height() + hhFixed - $(".aboutus .menu").height()) / 2 + 120) } else { itemsTop = parseInt(($(window).height() - items.height() + hhFixed - $(".aboutus .menu").height()) / 2 + 100) } } items.css("top", itemsTop); var li = $(".aboutus ul.menu li").eq(aboutSwiper.activeLoopIndex); var x = li.position();
 li.parent().find(".one").css("top", x.top).css("left", x.left);
 box = $(".contact .box");
 boxTop = parseInt(($(window).height() - box.height() + hhFixed) / 2);
 box.css("top", boxTop);
    var partner = $('#partner .box')
 partnerTop = parseInt(($(window).height() - partner.height()+$('header .bg').height()) / 2 );
 console.log($(window).height())
 console.log(partner.height())
 //partner.css({"top": '50%','transform': 'translate(0,-50%) translate(0,60px)'})
partner.css("top",partnerTop) 
}
function videoSwiperAnimation() { var e = $(".video .swiper-container .nth" + (videoSwiper.activeLoopIndex + 1).toString()).addClass("active"); if (videoSwiper.activeLoopIndex == 1) { if (e.find(".box").width() == $(window).width()) { e.find(".box").css("left", 0) } else { var offsetLeft = $(window).width() / 2 - e.find(".box").width() - 30;
   e.find(".box").css("left", offsetLeft) } } }

function resetVideoSwiperAnimation() { if (!loopPlayback) { return } $(".video .swiper-slide").removeClass("active");
 $(".video .swiper-container .nth2 .box").css("left", -350) }

function sectionAnimation() { if (pageIndex == 0) { videoSwiper.startAutoplay();
  videoSwiperAnimation(); return } else { videoSwiper.stopAutoplay() } var e = $("body>section").eq(pageIndex).addClass("active"); if (pageIndex == 2) { var prevBtn = $(".cases a.prev"); var nextBtn = $(".cases a.next"); if (prevBtn.css("display") == "block") { var btnTop = $(".cases .mini").position().top + 140;
   prevBtn.css("top", btnTop);
   nextBtn.css("top", btnTop) } casesSwiper.startAutoplay() } else { if (pageIndex == 3) { var clientsRow = parseInt($(".clients ul.items").height() / $(".clients ul.items li.one").height()); var clientsCol = parseInt($(".clients ul.items").width() / $(".clients ul.items li.one").width());
   $(".clients ul.items li:gt(1)").each(function(i, item) { if ((i + 1) % clientsCol != 0) { $(this).addClass("r") } else { $(this).removeClass("r") } if (i < clientsCol * (clientsRow - 1)) { $(this).addClass("b") } else { $(this).removeClass("b") } }) } else { if (pageIndex == 4) { prevBtn = $(".quality a.prev");
    nextBtn = $(".quality a.next"); if (prevBtn.css("display") == "block") { var btnTop = $(".quality .mini").position().top + 140;
     prevBtn.css("top", btnTop);
     nextBtn.css("top", btnTop) } } } } if (pageIndex == 6) { aboutSwiper.startAutoplay() } else { aboutSwiper.stopAutoplay() } }

function resetSectionAnimation() { if (!loopPlayback) { return } $("body>section").removeClass("active") }

function pageSwitching() { if (pageIndex < 0) { pageIndex = 0;
  stopSwitch = false; return } if (pageIndex >= $("body>section").size()) { pageIndex = $("body>section").size() - 1;
  stopSwitch = false; return } var lock = false;
 $("html,body").stop().animate({ scrollTop: $("body>section").eq(pageIndex).offset().top }, 300, "swing", function() { if (lock) { return } else { lock = true } resetVideoSwiperAnimation();
  resetSectionAnimation();
  sectionAnimation();
  stopSwitch = false }); if (pageIndex > 0) { $("header").addClass("fixed") } else { $("header").removeClass("fixed") } $("header .menu li").removeClass("active").eq(pageIndex).addClass("active");
 $("header .menu").trigger("mouseleave") }

function dockEvent() { $(".dock").height($(".dock ul.icons li").length * 50 + $(".dock a.switch").height() + 20).css("top", ($(window).height() - $(".dock").height()) / 2 + 35);
 $(".dock ul.icons li i").bind("mouseover click touchstart", function() { $(".dock ul.icons li").removeClass("active");
  $(this).parent().addClass("active") });
 $(".dock ul.icons li").bind("mouseleave", function() { $(".dock ul.icons li").removeClass("active") });
 $(".dock ul.icons li.up i").bind("click touchstart", function() { pageIndex--;
  pageSwitching() });
 $(".dock ul.icons li.down i").bind("click touchstart", function() { pageIndex++;
  pageSwitching() });
 $(".dock a.switch").bind("click", function() { if ($(this).hasClass("off")) { $(".dock").removeClass("close");
   $(this).removeClass("off") } else { $(".dock ul.icons li").removeClass("active");
   $(".dock").addClass("close");
   $(this).addClass("off") } }) }
